<?php 
    ...
    class Usuario{
        ...
        public function getTipo():string{return $this->strTipo;}
        public function getClave():string{return $this->strClave;}
        ...
        public function setCambiarClave(string $pass){$this->strClave = $pass;}
